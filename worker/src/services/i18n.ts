...
export const I18N_STRINGS: Record<string, Record<string, string>> = {
  ru: {
    ...
    btn_pay_stars: '⭐️ Оплатить звездами — 250 ⭐️',
  ...
  en: {
    ...
    btn_pay_stars: '⭐️ Pay with Stars — 250 ⭐️',
  ...
  de: {
    ...
    btn_pay_stars: '⭐️ Mit Stars zahlen — 250 ⭐️',
  ...
  it: {
    ...
    btn_pay_stars: '⭐️ Paga con Stars — 250 ⭐️',
