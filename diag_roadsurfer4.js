    ...
    if (returns.length > 0) {
      ...
      try {
          ...
          if (frames.length > 0) {
              ...
              console.log('Timeframes:', JSON.stringify(frames).substring(0, 200));
              let tf = frames[0];
              ...
              console.log('Offers length:', (sData.results || sData.data || sData || []).length);
              console.log('Offers:', JSON.stringify(sData).substring(0, 300));
              break;
          }
      } catch (e) {
